      ...
      >
        <Box sx={style}>
          ...
          <div className='h-56 overflow-hidden mb-4 bg-grey-light'>
            <img className='mx-auto max-h-full' src={API_URL + dataDeskripsi[0]?.imagePath} alt={dataDeskripsi[0]?.productName} />
          </div>
          <div className="mb-4">
                  ...
                  {paginatedProducts.map((row, index) => (
                    ...
                    >
                      ...
                      <TableCell align="left">
                        <Button sx={{ color: "#66806a" }} onClick={() => productDetailsHandler(row.id)} variant="text">Details</Button>
                      </TableCell>
                      <TableCell align="left">
