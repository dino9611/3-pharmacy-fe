...
const UserList = () => {
        ...
        <Box sx={style}>
          ...
          <div className='font-poppins'>
            <div className='flex items-center mb-3 text-sm'>
              <svg
                className='w-5 h-5 mr-3 text-primary1'
                fill='currentColor'
                viewBox='0 0 20 20'
  ...
  useEffect(() => {
    ...
    const getUserLength = async () => {
      try {
        let res = await axios.get(
          `${API_URL}/auth/userlength?username=${search}`
        );
    ...
    const getUserList = async () => {
      try {
        let res = await axios.get(
          `${API_URL}/auth/userlist?username=${search}&limit=${rowsPerPage}&offset=${offset}`
        );
  ...
  return (
    <div className='ml-64 px-8 py-6 font-poppins min-h-screen'>
      ...
      {userList.length ? (
        ...
        <div className='mt-24'>
          <img className='w-1/3 mx-auto mb-6' src={EmptyStreet} alt='empty' />
