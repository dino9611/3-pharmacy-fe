  ...
  const renderProducts = () => {
    return paginatedProducts.map((val, index) => {
      return (
        <div
          key={index + 1}
          className='m-2 bg-white rounded-md overflow-hidden p-4 shadow-md flex flex-col justify-between'
        >
          <div>
            <img
            ...
            <div>
              ...
              <p className='poppins text-gray-400 text-sm phone:text-xs'>
                Stock {val.stock}
              </p>
            </div>
          </div>
          <div>
            ...
            >
              <svg
                className='w-5 h-5 phone:w-4 phone:h-4 mr-1'
                fill='none'
                stroke='currentColor'
                viewBox='0 0 24 24'
